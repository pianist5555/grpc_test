...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in cancel_example_pb2_grpc.py depends on'
...
class CancelServiceStub(object):
...
class CancelServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_CancelServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cancel_example.CancelService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cancel_example.CancelService', rpc_method_handlers)
...
class CancelService(object):
    ...
    @staticmethod
    def LongRunningOperation(request,
            target,
            options=(),
